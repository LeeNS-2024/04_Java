...
public class TryCatchService {
	...
	public void test4() {
		...
		// InputMismatchException 에 빨간줄(컴파일 에러)이 발생하는 이유 :
...
//		}
	...
	public void test5() {
		...
		// Exception 클래스 : 모든 예외의 최상위 부모(RuntimeException 보다 상위)
		
		System.out.println("--- 던질 예외 선택 ---");
		System.out.println("1. Exception");
		System.out.println("2. RuntiomeException");
