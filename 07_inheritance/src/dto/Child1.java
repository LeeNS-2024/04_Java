...
public class Child1 extends Parent{
	...
	public String childInform() {
		...
		//		lastName, getAddress(), getMoney(), getCar() );
		
		return super.inform() + " / " + notebook;
	}
	
	/* 오버 라이딩(Overriding) : 덮어쓰기 / 재정의
	 * over 	: 위에 있다, 넘어서다
	 * Riding 	: 타는 것
	 * 
	 * - 부모로부터 물려받은 메서드를
	 * 	 자식이 같은 일므의 메서드를 만들어서 덮어쓰기
	 * 	 -> 물려받은 자식에 맞게
