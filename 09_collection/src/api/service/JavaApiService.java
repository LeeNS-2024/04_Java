...
//		String s2 = s1;
		...
		// 같은 값을 지닌 String 을 new 연산자를 이용해 생성
		String s3 = new String("Hello"); // 1804094807 (Heap 에 새로 생성)
		...
		// == s1, s2에 저장된 주소 값이 같음 
		// -> equals()를 사용하지 않아도 비교 가능 ( 문자열은 == 대신 equals()를 사용해야 됐음)
