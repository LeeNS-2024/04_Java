...
public class MemberView {
	...
	private int selectMenu() throws NumberFormatException, 
									 IOException {
		System.out.println("\n===== 회원 관리 프로그램 =====\n");
	...
	private void selectAll() {
		...
		// 	 memberList는 "절대로" null 이 될 수 없다!!!
		// -> 참조하는 List 는 있지만 비어있는지 검사를 해야한다!
		...
		for(Member member : memberList) {
			System.out.printf("%-5s %-12s %8d %4s \n",
